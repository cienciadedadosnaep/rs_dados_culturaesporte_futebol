...
df = pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_culturaesporte_futebol/data/POVOAMENTO.csv', sep = ';')
...
for i in range(0,len(df)):
    ...
    code = list(pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_culturaesporte_futebol/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
